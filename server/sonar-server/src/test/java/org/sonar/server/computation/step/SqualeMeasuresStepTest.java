...
import org.sonar.server.computation.squale.SqaleRatingGrid;
import org.sonar.server.computation.squale.SqaleRatingSettings;
...
import static org.sonar.server.computation.squale.SqaleRatingGrid.SqaleRating.A;
import static org.sonar.server.computation.squale.SqaleRatingGrid.SqaleRating.C;

public class SqualeMeasuresStepTest {
  ...
  private SqualeMeasuresStep underTest = new SqualeMeasuresStep(treeRootHolder, metricRepository, measureRepository, sqaleRatingSettings);
  ...
  @Test
  public void no_measure_created_for_MODULE_component() {
    treeRootHolder.setRoot(DumbComponent.builder(MODULE, 1).build());
  ...
  public void verify_aggregation_of_developmentCost_and_value_of_measures_computed_from_that() {
    ...
    // modules never have measures
    verifyNoMeasure(11);
    verifyNoMeasure(12);
    verifyNoMeasure(13);
    // project has aggregated dev cost of all files
    long devCost1 = devCost111 + devCost112 + devCost121;
